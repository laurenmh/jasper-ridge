...
write_csv(plst, "plantago-elymus.csv")
...
a2 <- ggplot(subset(plst2, rowdif < 10), aes(x=rowdif, y=cover, color = species)) + 
  geom_vline(xintercept = 1, color = "lightgrey", lwd = 10) + 
